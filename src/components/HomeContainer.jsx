  ...
  return (
    ...
    >
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        ...
        <button
          type="button"
          className="bg-gradient-to-br from-orange-400 to-orange-500 w-full md:w-auto px-4 py-2  rounded-lg hover:shadow-lg transition-all ease-in-out duration-100 shadow-lg"
        >
          Order Now
        </button>
        </Link>
      ...
      <div className="py-2 flex-1 flex items-center relative">
        ...
        {heroData && heroData.map(n=>(
            ...
            <img src={n.imageSrc} className="w-20 lg:w-40 -mt-10 lg:-mt-20 " alt="I1"/>
             ...
             <p className=" lg:text-sm font-semibold text-headingColor"><span className="text-xs text-red-600 ">$</span>{n.price}</p>
        </div>
        ))}
        </div>
        </div>
